    ...
    <div className="App">
      ...
      <div className='right-panel'>
        <div className='container stats-container'>
          <div className="stat-card">{artistData ? "This artist has a " + artistData.popularity + " rating in Spotify" : ""}</div>
          <div className="stat-card">{albums.length !== 0 ? "This artist has " + albums.length + " listed albums " : ""}</div>
